...
has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'Demo Client for Passmeister Apple Wallet and Google Wallet API',
                          app_version => '1.0.0',
...
WWW::SwaggerClient::Role - a Moose role for the Demo Client for Passmeister Apple Wallet and Google Wallet API

=head2 Demo Client for Passmeister Apple Wallet and Google Wallet API version: 1.0.0
